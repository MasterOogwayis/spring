...
/**
 * @author ZhangShaowei on 2019/6/19 9:20
 **/
public class CustomSpringCacheAnnotationParser implements CacheAnnotationParser, Serializable {
    ...
    private CacheableOperation parseCacheableAnnotation(
        ...
        CustomCacheable customCacheable = ae.getAnnotation(CustomCacheable.class);
        if (Objects.nonNull(customCacheable)) {
            builder.setExpire(customCacheable.expire());
            builder.setTimeUnit(customCacheable.timeUnit());
        }
