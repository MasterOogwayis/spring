...
import com.anze.mq.spring.api.impl.ali.AliSendResult;
...
public class RocketMQUtil {
    ...
    public static Message convertToRocketMessage(
        ...
        byte[] payloads = convertor.convert(message.getPayload());
